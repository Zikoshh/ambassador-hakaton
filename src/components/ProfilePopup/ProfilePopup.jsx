...
export default function ProfilePopup({
    ...
    handleAllPopupClose,
    handleProfileAccountClick,
    isProfilePopupAccount
}) {
        ...
        <>
            <div className={profileButtonClassName}>
                <div className="profile-popup__container">
                    ...
                    <p className="profile-popup__account">{isCurrentUser.first_name}</p>
                    <p className="profile-popup__email">{isCurrentUser.email}</p>
                </div>
                <div className="profile-popup__buttons">
                    <button className="profile-popup__button" onClick={handleProfileAccountClick}>
                        Личный кабинет
                    </button>
